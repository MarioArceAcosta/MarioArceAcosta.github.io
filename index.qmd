...
Some of the statistical analysis services I offer are: ✅Linear/nonlinear regression, probability modeling (LPM, logistic) ✅ A/B tests, T-tests, Chi-squared Tests, Hausman test, etc. ✅Panel (longitudinal) data analysis (Random/fixed/mixed effects) ✅Clustering, population weights, standardized coefficients ✅Event study / Difference-in-Differences (DiD) ✅Machine learning in R (logistic, KNN, Random Forests, etc.)

I also offer the following services: ✅ Tutoring (Statistics, Economics, and Mathematics) ✅Consultations in data governance and dashboards
